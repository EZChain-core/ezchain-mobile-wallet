...
import 'package:wallet/features/cross/cross.dart' as _i18;
import 'package:wallet/features/dashboard/dashboard.dart' as _i16;
import 'package:wallet/features/earn/earn.dart' as _i19;
...
import 'package:wallet/features/setting/change_pin/setting_change_pin.dart'
    as _i15;
import 'package:wallet/features/setting/setting.dart' as _i20;
...
import 'package:wallet/features/wallet/send/evm/wallet_send_evm_confirm.dart'
    as _i14;
import 'package:wallet/features/wallet/wallet.dart' as _i17;
...
class AppRouter extends _i21.RootStackRouter {
  ...
  final Map<String, _i21.PageFactory> pagesMap = {
    ...
    DashboardRoute.name: (routeData) {
      return _i21.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i16.DashboardScreen());
    },
    WalletRoute.name: (routeData) {
      return _i21.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i17.WalletScreen());
    },
    CrossRoute.name: (routeData) {
      return _i21.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i18.CrossScreen());
    },
    EarnRoute.name: (routeData) {
      return _i21.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i19.EarnScreen());
    },
    SettingRoute.name: (routeData) {
      return _i21.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i20.SettingScreen());
    }
  };
  ...
  List<_i21.RouteConfig> get routes => [
        ...
        _i21.RouteConfig(SplashRoute.name, path: '/splash'),
        _i21.RouteConfig(OnBoardRoute.name, path: '/onboard'),
        _i21.RouteConfig(AccessWalletOptionsRoute.name,
            path: '/access-wallet-options-screen'),
        _i21.RouteConfig(CreateWalletRoute.name, path: '/create-wallet-screen'),
        _i21.RouteConfig(CreateWalletConfirmRoute.name,
            path: '/create-wallet-confirm-screen'),
        _i21.RouteConfig(AccessPrivateKeyRoute.name,
            path: '/access-private-key-screen'),
        _i21.RouteConfig(AccessMnemonicKeyRoute.name,
            path: '/access-mnemonic-key-screen'),
        _i21.RouteConfig(PinCodeSetupRoute.name,
            path: '/pin-code-setup-screen'),
        _i21.RouteConfig(PinCodeConfirmRoute.name,
            path: '/pin-code-confirm-screen'),
        _i21.RouteConfig(WalletReceiveRoute.name,
            path: '/wallet-receive-screen'),
        _i21.RouteConfig(WalletSendAvmRoute.name,
            path: '/wallet-send-avm-screen'),
        _i21.RouteConfig(WalletSendAvmConfirmRoute.name,
            path: '/wallet-send-avm-confirm-screen'),
        _i21.RouteConfig(WalletSendEvmRoute.name,
            path: '/wallet-send-evm-screen'),
        _i21.RouteConfig(WalletSendEvmConfirmRoute.name,
            path: '/wallet-send-evm-confirm-screen'),
        _i21.RouteConfig(SettingChangePinRoute.name,
            path: '/setting-change-pin-screen'),
        _i21.RouteConfig(DashboardRoute.name, path: '/dashboard', children: [
          _i21.RouteConfig(WalletRoute.name,
              path: 'wallet', parent: DashboardRoute.name),
          _i21.RouteConfig(CrossRoute.name,
              path: 'cross', parent: DashboardRoute.name),
          _i21.RouteConfig(EarnRoute.name,
              path: 'earn', parent: DashboardRoute.name),
          _i21.RouteConfig(SettingRoute.name,
...
class AccessWalletOptionsRoute extends _i21.PageRouteInfo<void> {
...
class CreateWalletRoute extends _i21.PageRouteInfo<void> {
...
class CreateWalletConfirmRoute extends _i21.PageRouteInfo<void> {
...
class AccessPrivateKeyRoute extends _i21.PageRouteInfo<void> {
...
class AccessMnemonicKeyRoute extends _i21.PageRouteInfo<void> {
...
class PinCodeSetupRoute extends _i21.PageRouteInfo<void> {
...
class PinCodeConfirmRoute extends _i21.PageRouteInfo<PinCodeConfirmRouteArgs> {
...
class WalletReceiveRoute extends _i21.PageRouteInfo<void> {
...
class WalletSendAvmRoute extends _i21.PageRouteInfo<void> {
...
class WalletSendAvmConfirmRoute
    extends _i21.PageRouteInfo<WalletSendAvmConfirmRouteArgs> {
...
class WalletSendEvmRoute extends _i21.PageRouteInfo<void> {
...
class WalletSendEvmConfirmRoute
    extends _i21.PageRouteInfo<WalletSendEvmConfirmRouteArgs> {
...
class SettingChangePinRoute extends _i21.PageRouteInfo<void> {
...
/// generated route for [_i16.DashboardScreen]
...
/// generated route for [_i17.WalletScreen]
...
/// generated route for [_i18.CrossScreen]
class CrossRoute extends _i21.PageRouteInfo<void> {
  const CrossRoute() : super(name, path: 'cross');

  static const String name = 'CrossRoute';
}

/// generated route for [_i19.EarnScreen]
class EarnRoute extends _i21.PageRouteInfo<void> {
  const EarnRoute() : super(name, path: 'earn');

  static const String name = 'EarnRoute';
}

/// generated route for [_i20.SettingScreen]
