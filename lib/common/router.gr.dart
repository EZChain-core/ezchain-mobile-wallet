...
class AppRouter extends _i15.RootStackRouter {
  ...
  List<_i15.RouteConfig> get routes => [
        ...
        _i15.RouteConfig(SplashRoute.name, path: '/splash'),
        _i15.RouteConfig(OnBoardRoute.name, path: '/onboard'),
        _i15.RouteConfig(AccessWalletOptionsRoute.name,
            path: '/access-wallet-options-screen'),
        _i15.RouteConfig(CreateWalletRoute.name, path: '/create-wallet-screen'),
        _i15.RouteConfig(CreateWalletConfirmRoute.name,
            path: '/create-wallet-confirm-screen'),
        _i15.RouteConfig(AccessPrivateKeyRoute.name,
            path: '/access-private-key-screen'),
        _i15.RouteConfig(AccessMnemonicKeyRoute.name,
            path: '/access-mnemonic-key-screen'),
        _i15.RouteConfig(PinCodeSetupRoute.name,
            path: '/pin-code-setup-screen'),
        _i15.RouteConfig(PinCodeConfirmRoute.name,
            path: '/pin-code-confirm-screen'),
        _i15.RouteConfig(DashboardRoute.name, path: '/dashboard', children: [
          _i15.RouteConfig(WalletRoute.name,
              path: 'wallet', parent: DashboardRoute.name),
          _i15.RouteConfig(CrossRoute.name,
              path: 'cross', parent: DashboardRoute.name),
          _i15.RouteConfig(EarnRoute.name,
...
class AccessWalletOptionsRoute extends _i15.PageRouteInfo<void> {
...
class CreateWalletConfirmRoute extends _i15.PageRouteInfo<void> {
...
class AccessPrivateKeyRoute extends _i15.PageRouteInfo<void> {
...
class AccessMnemonicKeyRoute extends _i15.PageRouteInfo<void> {
...
class PinCodeSetupRoute extends _i15.PageRouteInfo<void> {
...
class PinCodeConfirmRoute extends _i15.PageRouteInfo<PinCodeConfirmRouteArgs> {
...
class CrossRoute extends _i15.PageRouteInfo<void> {
...
class EarnRoute extends _i15.PageRouteInfo<void> {
