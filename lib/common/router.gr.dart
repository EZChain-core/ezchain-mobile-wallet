...
import 'package:wallet/features/cross/cross.dart' as _i20;
import 'package:wallet/features/dashboard/dashboard.dart' as _i18;
import 'package:wallet/features/earn/earn.dart' as _i21;
...
import 'package:wallet/features/setting/setting.dart' as _i22;
...
import 'package:wallet/features/wallet/send/evm/wallet_send_evm_confirm.dart'
    as _i14;
import 'package:wallet/features/wallet/wallet.dart' as _i19;
...
class AppRouter extends _i23.RootStackRouter {
  ...
  final Map<String, _i23.PageFactory> pagesMap = {
    ...
    DashboardRoute.name: (routeData) {
      return _i23.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i18.DashboardScreen());
    },
    WalletRoute.name: (routeData) {
      return _i23.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i19.WalletScreen());
    },
    CrossRoute.name: (routeData) {
      return _i23.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i20.CrossScreen());
    },
    EarnRoute.name: (routeData) {
      return _i23.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i21.EarnScreen());
    },
    SettingRoute.name: (routeData) {
      return _i23.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i22.SettingScreen());
    }
  };
  ...
  List<_i23.RouteConfig> get routes => [
        ...
        _i23.RouteConfig(SplashRoute.name, path: '/splash'),
        _i23.RouteConfig(OnBoardRoute.name, path: '/onboard'),
        _i23.RouteConfig(AccessWalletOptionsRoute.name,
            path: '/access-wallet-options-screen'),
        _i23.RouteConfig(CreateWalletRoute.name, path: '/create-wallet-screen'),
        _i23.RouteConfig(CreateWalletConfirmRoute.name,
            path: '/create-wallet-confirm-screen'),
        _i23.RouteConfig(AccessPrivateKeyRoute.name,
            path: '/access-private-key-screen'),
        _i23.RouteConfig(AccessMnemonicKeyRoute.name,
            path: '/access-mnemonic-key-screen'),
        _i23.RouteConfig(PinCodeSetupRoute.name,
            path: '/pin-code-setup-screen'),
        _i23.RouteConfig(PinCodeConfirmRoute.name,
            path: '/pin-code-confirm-screen'),
        _i23.RouteConfig(WalletReceiveRoute.name,
            path: '/wallet-receive-screen'),
        _i23.RouteConfig(WalletSendAvmRoute.name,
            path: '/wallet-send-avm-screen'),
        _i23.RouteConfig(WalletSendAvmConfirmRoute.name,
            path: '/wallet-send-avm-confirm-screen'),
        _i23.RouteConfig(WalletSendEvmRoute.name,
            path: '/wallet-send-evm-screen'),
        _i23.RouteConfig(WalletSendEvmConfirmRoute.name,
            path: '/wallet-send-evm-confirm-screen'),
        _i23.RouteConfig(SettingChangePinRoute.name,
            path: '/setting-change-pin-screen'),
        _i23.RouteConfig(SettingGeneralRoute.name,
            path: '/setting-general-screen'),
        _i23.RouteConfig(SettingAboutRoute.name, path: '/setting-about-screen'),
        _i23.RouteConfig(DashboardRoute.name, path: '/dashboard', children: [
          _i23.RouteConfig(WalletRoute.name,
              path: 'wallet', parent: DashboardRoute.name),
          _i23.RouteConfig(CrossRoute.name,
              path: 'cross', parent: DashboardRoute.name),
          _i23.RouteConfig(EarnRoute.name,
              path: 'earn', parent: DashboardRoute.name),
          _i23.RouteConfig(SettingRoute.name,
...
class AccessWalletOptionsRoute extends _i23.PageRouteInfo<void> {
...
class CreateWalletRoute extends _i23.PageRouteInfo<void> {
...
class CreateWalletConfirmRoute extends _i23.PageRouteInfo<void> {
...
class AccessPrivateKeyRoute extends _i23.PageRouteInfo<void> {
...
class AccessMnemonicKeyRoute extends _i23.PageRouteInfo<void> {
...
class PinCodeSetupRoute extends _i23.PageRouteInfo<void> {
...
class PinCodeConfirmRoute extends _i23.PageRouteInfo<PinCodeConfirmRouteArgs> {
...
class WalletReceiveRoute extends _i23.PageRouteInfo<void> {
...
class WalletSendAvmRoute extends _i23.PageRouteInfo<void> {
...
class WalletSendAvmConfirmRoute
    extends _i23.PageRouteInfo<WalletSendAvmConfirmRouteArgs> {
...
class WalletSendEvmRoute extends _i23.PageRouteInfo<void> {
...
class WalletSendEvmConfirmRoute
    extends _i23.PageRouteInfo<WalletSendEvmConfirmRouteArgs> {
...
class SettingChangePinRoute extends _i23.PageRouteInfo<void> {
...
class SettingGeneralRoute extends _i23.PageRouteInfo<void> {
...
/// generated route for [_i19.WalletScreen]
...
/// generated route for [_i20.CrossScreen]
class CrossRoute extends _i23.PageRouteInfo<void> {
  const CrossRoute() : super(name, path: 'cross');

  static const String name = 'CrossRoute';
}

/// generated route for [_i21.EarnScreen]
class EarnRoute extends _i23.PageRouteInfo<void> {
  const EarnRoute() : super(name, path: 'earn');

  static const String name = 'EarnRoute';
}

/// generated route for [_i22.SettingScreen]
