  ...
  group("Transactions", () {
    ...
    setUpAll(() async {
      ...
      addrA = addressToString(
          "X", roiNetwork.hrp, cb58Decode("B6D4v1VtPYLbiUvYXtW4Px8oE9imC2vGW"));
      addrB = addressToString(
          "X", roiNetwork.hrp, cb58Decode("P5wdRuZeaDt28eHMP5S3w9ZdoBfo7wuzF"));
      addrC = addressToString(
          "X", roiNetwork.hrp, cb58Decode("6Y3kysjF9jnHnYkdS9yGAuoHyae2eNmeV"));
    });
    ...
    setUp(() async {
      set = AvmUTXOSet();
      avm.newKeyChain();
      keymgr2 = AvmKeyChain(chainId: alias, hrp: roi.getHRP());
      keymgr3 = AvmKeyChain(chainId: alias, hrp: roi.getHRP());
      addrs1 = [];
      addrs2 = [];
      addrs3 = [];
      utxos = [];
