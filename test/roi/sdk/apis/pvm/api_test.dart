...
void main() {
  group("Transactions", () {
    ...
    setUpAll(() async {
      ...
      final roiNetwork = roi as ROINetwork;

      pvm = PvmApi.create(roiNetwork: roiNetwork);
      ...
      addrA = addressToString(
          "P", roiNetwork.hrp, cb58Decode("B6D4v1VtPYLbiUvYXtW4Px8oE9imC2vGW"));
      addrB = addressToString(
          "P", roiNetwork.hrp, cb58Decode("P5wdRuZeaDt28eHMP5S3w9ZdoBfo7wuzF"));
      addrC = addressToString(
          "P", roiNetwork.hrp, cb58Decode("6Y3kysjF9jnHnYkdS9yGAuoHyae2eNmeV"));
    });
    ...
    setUp(() async {
      ...
      lset = PvmUTXOSet();
      pvm.newKeyChain();
      keymgr2 = PvmKeyChain(chainId: alias, hrp: roi.getHRP());
      keymgr3 = PvmKeyChain(chainId: alias, hrp: roi.getHRP());
      addrs1 = [];
      addrs2 = [];
      addrs3 = [];
      utxos = [];
